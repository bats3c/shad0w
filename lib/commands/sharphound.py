...
__description__ = "A C# rewrite of the BloodHound3 Ingestor, targeted for .NET 4.5"
...
SHARPHOUND_BIN = "/opt/shad0w/bin/SharpCollection/NetFramework_4.5_x86/SharpHound.exe"
