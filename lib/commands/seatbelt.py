...
__description__ = "Performs a number of security oriented host-survey \"safety checks\""
...
SEATBELT_BIN = "/opt/shad0w/bin/SharpCollection/NetFramework_4.5_x86/Seatbelt.exe"
