...
apt-get update -y
apt-get install -y python3 python3-pip python3-openssl gcc-mingw-w64 python3.8-dev nasm upx binutils wget apt-transport-https procps mono-complete less metasploit-framework
